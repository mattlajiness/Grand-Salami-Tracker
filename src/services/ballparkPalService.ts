...
const MANUAL_FACTORS: BallparkPalFactor[] = [
  ...
  },
  {
    ...
    single: 1.02,
    receptive: "Very High",
    windHours: [{ speed: 10, dir: "↗" }, { speed: 9, dir: "↗" }, { speed: 10, dir: "↑" }],
    tempHours: [84, 82, 81],
    humidity: 41,
    pressure: 1017,
    icons: ["↗", "↗", "↑", "〜", "☀️"],
  ...
  },
  {
    ...
    windHours: [{ speed: 7, dir: "↑" }, { speed: 4, dir: "↑" }, { speed: 7, dir: "↖" }],
    tempHours: [91, 90, 88],
    humidity: 32,
    pressure: 1011,
    icons: ["↑", "↑", "↖", "〜", "💥"],
  ...
  },
  {
    ...
    single: 1.01,
    receptive: "Med-High",
    windHours: [{ speed: 5, dir: "↖" }, { speed: 4, dir: "↖" }, { speed: 3, dir: "↖" }],
    tempHours: [77, 73, 73],
    humidity: 70,
    pressure: 1013,
    icons: ["↖", "↖", "↖", "☀️"],
  ...
  },
  {
    ...
    single: 0.92,
    receptive: "High",
    windHours: [{ speed: 9, dir: "↑" }, { speed: 12, dir: "↖" }, { speed: 14, dir: "↖" }],
    tempHours: [84, 82, 81],
    humidity: 44,
    pressure: 1016,
    icons: ["↑", "↖", "↖", "≈", "☀️"],
