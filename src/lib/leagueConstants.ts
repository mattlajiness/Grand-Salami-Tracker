...
export const DetailedVenueFactors: Record<string, DetailedParkFactor> = {
  "Coors Field": { hr: 1.28, extraBase: 1.31, single: 1.17, runs: 1.38 },
  "Great American Ball Park": { hr: 1.30, extraBase: 1.03, single: 0.97, runs: 1.15 },
  "Great American BP": { hr: 1.30, extraBase: 1.03, single: 0.97, runs: 1.15 },
  "Citizens Bank Park": { hr: 1.13, extraBase: 0.99, single: 1.01, runs: 1.07 },
  "PNC Park": { hr: 0.94, extraBase: 1.10, single: 1.03, runs: 1.04 },
  "Target Field": { hr: 1.01, extraBase: 1.01, single: 1.00, runs: 1.02 },
  "Kauffman Stadium": { hr: 1.05, extraBase: 1.03, single: 0.99, runs: 1.01 },
  "Fenway Park": { hr: 0.85, extraBase: 1.12, single: 1.05, runs: 1.00 },
  "Wrigley Field": { hr: 1.08, extraBase: 0.86, single: 0.97, runs: 0.96 },
  "Tropicana Field": { hr: 0.96, extraBase: 0.93, single: 0.92, runs: 0.94 },
  "Tropicana Field (Closed)": { hr: 0.96, extraBase: 0.93, single: 0.92, runs: 0.94 },
  "Citi Field": { hr: 0.94, extraBase: 0.76, single: 0.95, runs: 0.88 },
  "Sutter Health Park": { hr: 1.39, extraBase: 1.10, single: 1.07, runs: 1.26 },
  "Progressive Field": { hr: 1.19, extraBase: 0.97, single: 0.99, runs: 1.07 },
  ...
  "Daikin Park": { hr: 1.05, extraBase: 0.89, single: 0.96, runs: 0.95 },
  "Daikin Park (Closed)": { hr: 1.05, extraBase: 0.89, single: 0.96, runs: 0.95 },
  "Minute Maid Park": { hr: 1.05, extraBase: 0.89, single: 0.96, runs: 0.95 },
  "Minute Maid Park (Closed)": { hr: 1.05, extraBase: 0.89, single: 0.96, runs: 0.95 },
