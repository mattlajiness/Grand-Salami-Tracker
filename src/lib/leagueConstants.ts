...
export const DetailedVenueFactors: Record<string, DetailedParkFactor> = {
  "Coors Field": { hr: 1.23, extraBase: 1.26, single: 1.20, runs: 1.35 },
  "Sutter Health Park": { hr: 1.28, extraBase: 1.11, single: 1.05, runs: 1.20 },
  "Oriole Park": { hr: 0.72, extraBase: 1.18, single: 1.13, runs: 1.05 },
  "Oriole Park at Camden Yards": { hr: 0.72, extraBase: 1.18, single: 1.13, runs: 1.05 },
  "Dodger Stadium": { hr: 1.20, extraBase: 0.91, single: 0.94, runs: 0.99 },
  "Citizens Bank Park": { hr: 0.82, extraBase: 1.01, single: 1.06, runs: 0.98 },
  "Truist Park": { hr: 1.01, extraBase: 0.89, single: 1.03, runs: 0.97 },
  "Comerica Park": { hr: 0.80, extraBase: 1.00, single: 1.10, runs: 0.97 },
  "Oracle Park": { hr: 0.79, extraBase: 1.05, single: 1.06, runs: 0.95 },
