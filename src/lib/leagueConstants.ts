...
export const DetailedVenueFactors: Record<string, DetailedParkFactor> = {
  "Coors Field": { hr: 1.00, extraBase: 1.23, single: 1.13, runs: 1.18 },
  "Sutter Health Park": { hr: 1.22, extraBase: 1.11, single: 1.03, runs: 1.16 },
  "Kauffman Stadium": { hr: 0.86, extraBase: 0.96, single: 0.99, runs: 0.90 },
  "Fenway Park": { hr: 0.79, extraBase: 1.23, single: 1.14, runs: 1.09 },
  "Angel Stadium": { hr: 0.95, extraBase: 0.92, single: 1.06, runs: 1.00 },
  ...
  "Comerica Park": { hr: 0.80, extraBase: 0.99, single: 1.07, runs: 0.94 },
  "Yankee Stadium": { hr: 1.17, extraBase: 0.89, single: 0.93, runs: 1.00 },
  "Nationals Park": { hr: 1.11, extraBase: 1.10, single: 1.06, runs: 1.12 },
  "T-Mobile Park": { hr: 1.04, extraBase: 0.83, single: 0.91, runs: 0.90 },
  "Busch Stadium": { hr: 0.69, extraBase: 0.93, single: 1.05, runs: 0.85 },
  "Wrigley Field": { hr: 0.76, extraBase: 0.84, single: 0.99, runs: 0.82 },
  "Minute Maid Park": { hr: 1.04, extraBase: 0.88, single: 0.96, runs: 0.95 },
  "Oracle Park": { hr: 0.80, extraBase: 1.01, single: 1.03, runs: 0.92 },
  "Citizens Bank Park": { hr: 1.33, extraBase: 1.01, single: 1.03, runs: 1.17 },
  "Chase Field": { hr: 0.92, extraBase: 1.12, single: 1.00, runs: 1.01 },
};
