...
export const DetailedVenueFactors: Record<string, DetailedParkFactor> = {
  "Sutter Health Park": { hr: 1.37, extraBase: 1.19, single: 1.08, runs: 1.30 },
  "Rogers Centre": { hr: 1.22, extraBase: 1.07, single: 0.98, runs: 1.10 },
  "Rogers Centre (Open)": { hr: 1.22, extraBase: 1.07, single: 0.98, runs: 1.10 },
  "Dodger Stadium": { hr: 1.19, extraBase: 1.00, single: 0.95, runs: 1.03 },
  "Target Field": { hr: 0.96, extraBase: 1.05, single: 0.98, runs: 1.00 },
  ...
  "Angel Stadium": { hr: 0.98, extraBase: 0.95, single: 1.00, runs: 0.98 },
  "Busch Stadium": { hr: 1.06, extraBase: 0.91, single: 1.03, runs: 0.97 },
  "Truist Park": { hr: 1.03, extraBase: 0.93, single: 0.97, runs: 0.95 },
  "Oracle Park": { hr: 0.76, extraBase: 1.11, single: 1.03, runs: 0.94 },
  "Petco Park": { hr: 0.98, extraBase: 0.91, single: 0.95, runs: 0.94 },
