...
export const DetailedVenueFactors: Record<string, DetailedParkFactor> = {
  ...
  "Kauffman Stadium": { hr: 1.11, extraBase: 1.04, single: 1.05, runs: 1.09 },
  "Fenway Park": { hr: 0.90, extraBase: 1.28, single: 1.12, runs: 1.15 },
  ...
  "Petco Park": { hr: 0.91, extraBase: 0.82, single: 0.95, runs: 0.88 },
  ...
  "Citizens Bank Park": { hr: 1.03, extraBase: 0.90, single: 1.04, runs: 1.01 },
