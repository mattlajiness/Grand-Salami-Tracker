...
export const VenueParkFactors: Record<string, number> = {
  ...
  "Kauffman Stadium": 1.09,
  "Citizens Bank Park": 1.07,
  "Wrigley Field": 1.05,
  "Oriole Park": 1.04,
  "Oriole Park at Camden Yards": 1.04,
...
export const DetailedVenueFactors: Record<string, DetailedParkFactor> = {
  "Coors Field": { hr: 1.25, extraBase: 1.23, single: 1.20, runs: 1.35 },
  ...
  "Kauffman Stadium": { hr: 1.17, extraBase: 1.01, single: 1.03, runs: 1.09 },
  "Citizens Bank Park": { hr: 1.13, extraBase: 1.00, single: 1.01, runs: 1.07 },
  "Wrigley Field": { hr: 1.26, extraBase: 0.90, single: 0.96, runs: 1.05 },
  "Oriole Park": { hr: 1.01, extraBase: 1.13, single: 1.00, runs: 1.04 },
  "Oriole Park at Camden Yards": { hr: 1.01, extraBase: 1.13, single: 1.00, runs: 1.04 },
  "Progressive Field": { hr: 1.07, extraBase: 1.00, single: 0.97, runs: 1.03 },
  "PNC Park": { hr: 0.88, extraBase: 1.15, single: 1.00, runs: 1.02 },
  ...
  "Fenway Park": { hr: 0.91, extraBase: 1.01, single: 1.02, runs: 0.96 },
  ...
  "Globe Life Field": { hr: 0.89, extraBase: 0.93, single: 0.98, runs: 0.92 },
  "Globe Life Field (Closed)": { hr: 0.89, extraBase: 0.93, single: 0.98, runs: 0.92 },
  "Citi Field": { hr: 0.91, extraBase: 0.77, single: 0.96, runs: 0.88 },
  "Sutter Health Park": { hr: 1.39, extraBase: 1.10, single: 1.07, runs: 1.26 },
  "Comerica Park": { hr: 1.13, extraBase: 1.02, single: 1.01, runs: 1.05 },
  "Dodger Stadium": { hr: 1.21, extraBase: 0.98, single: 0.95, runs: 1.02 },
  "Truist Park": { hr: 1.05, extraBase: 1.01, single: 0.99, runs: 1.01 },
  ...
  "Oracle Park": { hr: 0.77, extraBase: 1.10, single: 1.04, runs: 0.95 },
