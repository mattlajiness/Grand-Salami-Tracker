...
export const DetailedVenueFactors: Record<string, DetailedParkFactor> = {
  "Sutter Health Park": { hr: 1.34, extraBase: 1.18, single: 1.07, runs: 1.27 },
  "Nationals Park": { hr: 1.19, extraBase: 1.04, single: 1.04, runs: 1.11 },
  "Rogers Centre": { hr: 1.11, extraBase: 1.00, single: 1.01, runs: 1.04 },
  "Rogers Centre (Open)": { hr: 1.11, extraBase: 1.00, single: 1.01, runs: 1.04 },
  "Dodger Stadium": { hr: 1.18, extraBase: 1.01, single: 0.97, runs: 1.03 },
  "Target Field": { hr: 1.00, extraBase: 1.04, single: 1.01, runs: 1.03 },
  "Yankee Stadium": { hr: 1.11, extraBase: 0.94, single: 0.95, runs: 1.01 },
  "Angel Stadium": { hr: 0.96, extraBase: 0.99, single: 1.04, runs: 1.01 },
  "Busch Stadium": { hr: 1.04, extraBase: 0.91, single: 1.08, runs: 1.00 },
  "Comerica Park": { hr: 0.93, extraBase: 1.02, single: 1.05, runs: 1.00 },
  ...
  "Truist Park": { hr: 1.05, extraBase: 0.95, single: 0.99, runs: 0.99 },
  "Rate Field": { hr: 0.99, extraBase: 0.90, single: 1.00, runs: 0.96 },
  "Guaranteed Rate Field": { hr: 0.99, extraBase: 0.90, single: 1.00, runs: 0.96 },
  "Petco Park": { hr: 0.99, extraBase: 0.95, single: 0.95, runs: 0.96 },
  "Oracle Park": { hr: 0.76, extraBase: 1.12, single: 1.03, runs: 0.95 },
