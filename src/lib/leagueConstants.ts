...
export const DetailedVenueFactors: Record<string, DetailedParkFactor> = {
  ...
  "Great American Ball Park": { hr: 1.25, extraBase: 0.90, single: 1.05, runs: 1.13 },
  "Great American BP": { hr: 1.25, extraBase: 0.90, single: 1.05, runs: 1.13 },
  "Progressive Field": { hr: 1.19, extraBase: 0.97, single: 0.99, runs: 1.07 },
  "Wrigley Field": { hr: 1.21, extraBase: 0.91, single: 0.99, runs: 1.06 },
  "Comerica Park": { hr: 1.13, extraBase: 1.02, single: 1.01, runs: 1.05 },
  "PNC Park": { hr: 1.01, extraBase: 1.14, single: 0.95, runs: 1.03 },
  "Dodger Stadium": { hr: 1.21, extraBase: 0.98, single: 0.95, runs: 1.02 },
  "Target Field": { hr: 1.01, extraBase: 0.99, single: 1.02, runs: 1.02 },
  ...
  "Tropicana Field": { hr: 0.98, extraBase: 0.93, single: 0.92, runs: 0.94 },
  "Tropicana Field (Closed)": { hr: 0.98, extraBase: 0.93, single: 0.92, runs: 0.94 },
  "Citi Field": { hr: 1.04, extraBase: 0.82, single: 0.93, runs: 0.93 },
