...
export const DetailedVenueFactors: Record<string, DetailedParkFactor> = {
  ...
  "Comerica Park": { hr: 1.00, extraBase: 1.02, single: 1.12, runs: 1.08 },
  "Rate Field": { hr: 1.05, extraBase: 0.92, single: 1.05, runs: 1.03 },
  "Guaranteed Rate Field": { hr: 1.05, extraBase: 0.92, single: 1.05, runs: 1.03 },
  "Nationals Park": { hr: 1.09, extraBase: 0.99, single: 1.01, runs: 1.02 },
  ...
  "Dodger Stadium": { hr: 1.14, extraBase: 0.98, single: 0.95, runs: 0.99 },
  "Rogers Centre": { hr: 1.13, extraBase: 0.95, single: 0.97, runs: 0.99 },
  "Rogers Centre (Open)": { hr: 1.13, extraBase: 0.95, single: 0.97, runs: 0.99 },
  "Yankee Stadium": { hr: 1.14, extraBase: 0.77, single: 0.98, runs: 0.98 },
  "Oracle Park": { hr: 0.90, extraBase: 1.11, single: 1.00, runs: 0.97 },
  "Petco Park": { hr: 1.05, extraBase: 0.87, single: 0.98, runs: 0.97 },
  "Angel Stadium": { hr: 0.97, extraBase: 0.93, single: 0.99, runs: 0.96 },
  "LoanDepot Park": { hr: 0.87, extraBase: 1.02, single: 0.98, runs: 0.95 },
  "LoanDepot Park (Closed)": { hr: 0.87, extraBase: 1.02, single: 0.98, runs: 0.95 },
