...
export const DetailedVenueFactors: Record<string, DetailedParkFactor> = {
  "Sutter Health Park": { hr: 1.31, extraBase: 1.20, single: 1.00, runs: 1.21 },
  "Great American Ball Park": { hr: 1.20, extraBase: 1.00, single: 0.99, runs: 1.11 },
  "Great American BP": { hr: 1.20, extraBase: 1.00, single: 0.99, runs: 1.11 },
  "Dodger Stadium": { hr: 1.21, extraBase: 0.99, single: 0.99, runs: 1.06 },
  "Progressive Field": { hr: 1.07, extraBase: 0.99, single: 0.99, runs: 1.03 },
  "Truist Park": { hr: 1.05, extraBase: 1.00, single: 1.01, runs: 1.03 },
  "Target Field": { hr: 1.04, extraBase: 0.93, single: 1.02, runs: 1.01 },
  "Rogers Centre": { hr: 1.03, extraBase: 1.03, single: 0.98, runs: 1.00 },
  "Rogers Centre (Open)": { hr: 1.03, extraBase: 1.03, single: 0.98, runs: 1.00 },
  "Comerica Park": { hr: 0.92, extraBase: 1.02, single: 1.05, runs: 0.99 },
  "Angel Stadium": { hr: 0.96, extraBase: 0.97, single: 1.01, runs: 0.98 },
  "Wrigley Field": { hr: 1.18, extraBase: 0.81, single: 0.96, runs: 0.98 },
  "PNC Park": { hr: 0.82, extraBase: 1.12, single: 0.99, runs: 0.97 },
  ...
  "Tropicana Field (Closed)": { hr: 0.97, extraBase: 0.93, single: 0.92, runs: 0.94 },
  "Oracle Park": { hr: 0.77, extraBase: 1.00, single: 1.05, runs: 0.92 },
  "Citi Field": { hr: 0.94, extraBase: 0.80, single: 0.96, runs: 0.90 },
