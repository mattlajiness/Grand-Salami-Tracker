...
export const VenueParkFactors: Record<string, number> = {
  ...
  "Great American BP": 1.12,
  "Progressive Field": 1.03,
  "American Family Fld": 1.02,
...
export const DetailedVenueFactors: Record<string, DetailedParkFactor> = {
  "Coors Field": { hr: 1.19, extraBase: 1.22, single: 1.13, runs: 1.26 },
  "Sutter Health Park": { hr: 1.27, extraBase: 1.15, single: 1.03, runs: 1.20 },
  "Oriole Park": { hr: 0.77, extraBase: 1.17, single: 1.06, runs: 1.01 },
  "Oriole Park at Camden Yards": { hr: 0.77, extraBase: 1.17, single: 1.06, runs: 1.01 },
  "Dodger Stadium": { hr: 1.24, extraBase: 0.95, single: 0.92, runs: 1.00 },
  "Citizens Bank Park": { hr: 0.80, extraBase: 1.01, single: 1.03, runs: 0.96 },
  "Truist Park": { hr: 0.82, extraBase: 0.89, single: 0.99, runs: 0.86 },
  "Comerica Park": { hr: 0.71, extraBase: 1.05, single: 1.00, runs: 0.88 },
  "Oracle Park": { hr: 0.84, extraBase: 1.06, single: 1.04, runs: 0.97 },
  "Kauffman Stadium": { hr: 0.93, extraBase: 1.02, single: 1.03, runs: 0.99 },
  "Globe Life Field": { hr: 0.89, extraBase: 0.92, single: 0.99, runs: 0.92 },
  "Globe Life Field (Closed)": { hr: 0.89, extraBase: 0.92, single: 0.99, runs: 0.92 },
  "Globe Life Field (Open)": { hr: 1.02, extraBase: 0.98, single: 1.01, runs: 1.01 },
  "PNC Park": { hr: 0.66, extraBase: 1.00, single: 0.96, runs: 0.83 },
  "Fenway Park": { hr: 0.58, extraBase: 1.15, single: 0.98, runs: 0.85 },
  "T-Mobile Park": { hr: 0.91, extraBase: 0.76, single: 0.91, runs: 0.82 },
  "T-Mobile Park (Open)": { hr: 0.91, extraBase: 0.76, single: 0.91, runs: 0.82 },
  "T-Mobile Park (Closed)": { hr: 0.88, extraBase: 0.82, single: 0.93, runs: 0.85 },
  "Yankee Stadium": { hr: 0.72, extraBase: 0.98, single: 0.89, runs: 0.82 },
  "Wrigley Field": { hr: 0.68, extraBase: 0.85, single: 0.92, runs: 0.74 },
  "Great American Ball Park": { hr: 1.18, extraBase: 1.04, single: 1.00, runs: 1.12 },
  "Great American BP": { hr: 1.18, extraBase: 1.04, single: 1.00, runs: 1.12 },
  "Progressive Field": { hr: 1.07, extraBase: 1.00, single: 0.97, runs: 1.03 },
  "American Family Fld": { hr: 1.13, extraBase: 1.00, single: 0.91, runs: 1.02 },
  "American Family Field": { hr: 1.13, extraBase: 1.00, single: 0.91, runs: 1.02 },
  "Target Field": { hr: 0.95, extraBase: 1.01, single: 1.01, runs: 1.00 },
  "Daikin Park": { hr: 1.06, extraBase: 0.89, single: 0.96, runs: 0.96 },
  "Daikin Park (Closed)": { hr: 1.06, extraBase: 0.89, single: 0.96, runs: 0.96 },
  "Minute Maid Park": { hr: 1.06, extraBase: 0.89, single: 0.96, runs: 0.96 },
  "Minute Maid Park (Closed)": { hr: 1.06, extraBase: 0.89, single: 0.96, runs: 0.96 },
  "Tropicana Field": { hr: 0.97, extraBase: 0.94, single: 0.93, runs: 0.94 },
  "Tropicana Field (Closed)": { hr: 0.97, extraBase: 0.94, single: 0.93, runs: 0.94 },
  "Citi Field": { hr: 0.91, extraBase: 0.77, single: 0.96, runs: 0.88 },
  "Angel Stadium": { hr: 0.91, extraBase: 0.96, single: 1.05, runs: 0.99 },
  "Rogers Centre": { hr: 1.11, extraBase: 0.91, single: 0.99, runs: 0.99 },
  "Rogers Centre (Open)": { hr: 1.11, extraBase: 0.91, single: 0.99, runs: 0.99 },
  ...
  "Chase Field": { hr: 0.92, extraBase: 1.11, single: 1.00, runs: 1.00 },
