...
export const DetailedVenueFactors: Record<string, DetailedParkFactor> = {
  ...
  "Sutter Health Park": { hr: 1.31, extraBase: 1.15, single: 1.03, runs: 1.20 },
  ...
  "Comerica Park": { hr: 0.90, extraBase: 0.99, single: 1.02, runs: 0.99 },
  "Oracle Park": { hr: 0.84, extraBase: 1.09, single: 1.03, runs: 0.97 },
