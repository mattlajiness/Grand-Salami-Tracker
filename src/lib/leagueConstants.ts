...
export const DetailedVenueFactors: Record<string, DetailedParkFactor> = {
  "Sutter Health Park": { hr: 1.32, extraBase: 1.16, single: 1.00, runs: 1.21 },
  "Great American Ball Park": { hr: 1.20, extraBase: 1.11, single: 1.04, runs: 1.20 },
  "Great American BP": { hr: 1.20, extraBase: 1.11, single: 1.04, runs: 1.20 },
  "Truist Park": { hr: 1.07, extraBase: 0.98, single: 1.01, runs: 1.03 },
  "PNC Park": { hr: 0.85, extraBase: 1.14, single: 1.01, runs: 1.01 },
  "Progressive Field": { hr: 0.93, extraBase: 1.07, single: 0.98, runs: 1.01 },
  "Comerica Park": { hr: 0.95, extraBase: 1.02, single: 1.05, runs: 1.00 },
  "Dodger Stadium": { hr: 1.12, extraBase: 0.97, single: 0.96, runs: 0.99 },
  "Angel Stadium": { hr: 0.91, extraBase: 0.98, single: 1.02, runs: 0.97 },
  "Rogers Centre": { hr: 1.01, extraBase: 0.98, single: 0.98, runs: 0.97 },
  "Rogers Centre (Open)": { hr: 1.01, extraBase: 0.98, single: 0.98, runs: 0.97 },
  ...
  "Oracle Park": { hr: 0.81, extraBase: 1.03, single: 1.06, runs: 0.95 },
  ...
  "Wrigley Field": { hr: 0.98, extraBase: 0.81, single: 1.03, runs: 0.94 },
  "Citi Field": { hr: 0.97, extraBase: 0.77, single: 0.99, runs: 0.92 },
