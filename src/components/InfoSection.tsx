  ...
  return (
    <div id="how-it-works" className="mt-12 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="dashboard-card p-6 bg-white dark:bg-slate-900/50 border-slate-200 dark:border-slate-800 shadow-lg">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-black text-slate-900 dark:text-white uppercase tracking-tighter text-lg mb-2">What is a Grand Salami?</h3>
              <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                In MLB betting, the <span className="text-salami-red font-bold">Grand Salami</span> is a unique wager on the <span className="font-bold text-slate-800 dark:text-slate-200">Total Runs scored across every single game</span> on a specific day's slate. 
        ...
        <div className="dashboard-card p-6 bg-white dark:bg-slate-900/50 border-slate-200 dark:border-slate-800 shadow-lg">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-black text-slate-900 dark:text-white uppercase tracking-tighter text-lg mb-2">Real-Time Projections</h3>
              <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                Our tracker doesn't just count finished games. We use a <span className="font-bold text-slate-800 dark:text-slate-200">Granular Extrapolation Engine</span> that monitors every half-inning. 
